			...
			steps {
				sshagent ( ['projects-storage.eclipse.org-bot-ssh']) {
					sh '''
						...
						scp -r org.eclipse.swtimagej.updatesite/target/repository/* genie.swtimagej@projects-storage.eclipse.org:/home/data/httpd/download.eclipse.org/swtimagej/integration/${BRANCH_NAME}/repository
					'''
				}
			}
		}
