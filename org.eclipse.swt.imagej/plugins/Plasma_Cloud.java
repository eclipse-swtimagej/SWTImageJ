...
/**
 * This is a plugin version of the PlasmaCloud.java program from Section 2.3
 * (Recursion) of the book "Introduction to Programming in Java" by Robert
...
public class Plasma_Cloud implements PlugIn {
	...
	// centered at (x, y), of given size, using given standard deviation for
	// computing the
	// displacement, and with upper left, upper right, lower lower, and lower right
	// hues c1, c2, c3, c4
