...
public class IJ {
	...
	// public static org.eclipse.swt.graphics.Font font12 = new
	// org.eclipse.swt.graphics.Font(Display.getDefault(),
	...
	static void init() {
		...
		/*
		 * Menus m = new Menus(null, null); Prefs.load(m, null); m.addMenuBar(m);
		 */
	}
	...
	static void selectWindow(Object win) {
		...
		if(win instanceof WindowSwt) {
			Display.getDefault().syncExec(() -> {
				((WindowSwt)win).getShell().setActive();
			});
