...
public class JavaProperties implements PlugIn {
	...
	public void run(String arg) {
		...
		Rectangle s2 = GUI.getScreenBounds(IJ.getInstance().getShell()); // screen with "ImageJ" window
		if(s1.equals(s2))
		...
		list.add("  Max window bounds: " + toString(GUI.getMaxWindowBounds(IJ.getInstance().getShell())));
