...
public class ImageProperties implements PlugInFilter, org.eclipse.swt.events.ModifyListener {
	...
	ImagePlus imp;
	static final int NANOMETER = 0, MICROMETER = 1, MILLIMETER = 2, CENTIMETER = 3, METER = 4, KILOMETER = 5, INCH = 6,
			FOOT = 7, MILE = 8, PIXEL = 9, OTHER_UNIT = 10;
	int oldUnitIndex;
	...
	org.eclipse.swt.widgets.Text pixelWidthField, pixelHeightField, pixelDepthField;
	...
	void showDialog(ImagePlus imp) {
		...
		if (channels * slices * frames == stackSize)
			...
			IJ.error("Properties", "The product of channels (" + channels + "), slices (" + slices + ")\n and frames ("
					+ frames + ") must equal the stack size (" + stackSize + ").");
		String unit = "";
		if (legacyMacro)
