...
public class Convolver implements ExtendedPlugInFilter, DialogListener, ActionListener {
	...
	/**
	 * Convolves <code>ip</code> with a kernel of width <code>kw</code> and height
	 ...
	 * convolveFloat1D() (4 argument version) methods divide each kernel coefficient
	 ...
	 * <code>kw</code> and height <code>kh</code>. Returns false if the user cancels
