...
public interface PlugInFilter {
	...
	/**
	 * Set this flag if the filter handles 64-bit (DoubleProcessor) images.
	 * <p>
	 * Filters that compute in full IEEE-754 double precision should declare
	 * this flag so that the {@link PlugInFilterRunner} enables their menu
	 * command on 64-bit images. See {@link ij.process.DoubleProcessor}.
	 * <p>
	 * Bit value is {@code 0x00800000} (8388608) — chosen so it does not
	 * collide with any of the existing flags above and stays below the
	 * {@code 0x01000000} band reserved for {@link ExtendedPlugInFilter}.
	 */
	public final int DOES_64 = 0x00800000;
