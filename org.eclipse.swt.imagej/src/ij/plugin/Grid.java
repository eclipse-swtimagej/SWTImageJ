...
public class Grid implements PlugIn, DialogListener {
	...
	private org.eclipse.swt.widgets.Button centerCheckbox, randomCheckbox;
	...
	private boolean showDialog() {
		...
		if (!isMacro) {
			...
			centerCheckbox = (org.eclipse.swt.widgets.Button)v.elementAt(1);
			randomCheckbox = (org.eclipse.swt.widgets.Button)v.elementAt(2);
		}
	...
	public boolean dialogItemChanged(GenericDialog gd, TypedEvent e) {
		...
		if (randomOffset) {
			...
			if (centerCheckbox!=null)
				centerCheckbox.setSelection(false);
		}
