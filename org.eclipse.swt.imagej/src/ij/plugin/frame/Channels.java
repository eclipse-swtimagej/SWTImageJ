...
public class Channels extends PlugInDialog implements PlugIn, SelectionListener {
	...
	private static final int COMP = 0, COLOR = 1, GRAY = 2, DIVIDER = 3,
			MAX = 4, MIN = 5, INVERT = 6;
	...
	public void itemStateChanged(SelectionEvent e) {
		...
		if(source == choice) {
			...
			if(cmode == IJ.COMPOSITE && (("Min".equals(cstr) || "Invert".equals(cstr)) && !imp.isInvertedLut()) || ("Max".equals(cstr) || "Sum".equals(cstr)) && imp.isInvertedLut())
