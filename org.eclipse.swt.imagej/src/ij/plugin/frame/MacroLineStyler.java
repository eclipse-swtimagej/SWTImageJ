...
/* JavaLineStyler source from: http://www.java2s.com/Code/Java/SWT-JFace-Eclipse/JavaSourcecodeViewer.htm */
/*******************************************************************************
 ...
 ******************************************************************************/
class MacroLineStyler implements LineStyleListener {
	...
	public class MacroScanner {
		...
		private String[] fgKeywords = { "macro", "var", "if", "else", "while", "do", "for", "function", "return",
				/* "true", "false", "PI", "NaN", */ "break", "continue" };
