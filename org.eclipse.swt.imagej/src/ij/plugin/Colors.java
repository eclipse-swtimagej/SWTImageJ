...
public class Colors implements PlugIn, SelectionListener {
	...
	/**
	 * For named colors, returns the name, or 'defaultName' if not a named color. If
	 * 'defaultName' is non-null and starts with an uppercase character, the
	 * returned name is capitalized (first character uppercase). Use colorToString
	 * or colorToString2 to get a String representation (hexadecimal) also for
	 * unnamed colors.
	 */
	 ...
	 * Returns 'defaultColor' if the color has no name. Use 'decode' to also decode
	 * hex color names like "#ffff00"
	 */
	...
	/**
	 * Converts a String with the color name or the hexadecimal representation of a
	 * color with 6 or 8 hex digits to a Color. With 8 hex digits, the first two
	 * digits are the alpha. With 6 hex digits, the color is opaque (alpha = hex
	 * ff). A hex String may be preceded by '#' such as "#80ff00". When the string
	 * does not include a valid color name or hex code, returns Color.GRAY.
	 */
	 ...
	 * color with 6 or 8 hex digits to a Color. With 8 hex digits, the first two
	 * digits are the alpha. With 6 hex digits, the color is opaque (alpha = hex
	 * ff). A hex String may be preceded by "#" such as "#80ff00" or "0x". When the
	 * string does not include a valid color name or hex code, returns
	 * 'defaultColor'.
	 */
	...
	/**
	 * Converts a hex color (e.g., "ffff00" or "#ffff00") into a color name "Red",
	 * "Green", "Yellow", etc. Returns null if the hex color does not have a name.
	 ...
	 * Values is outside the 0-255 range are replaced by the nearest valid number (0
	 * or 255)
	 */
	 ...
	 * predefined color names "Red", "Green", ... "Pink". The Strings arguments must
	 * be either "None" or hex codes starting with "#". Any null arguments are
	 * ignored.
	 */
