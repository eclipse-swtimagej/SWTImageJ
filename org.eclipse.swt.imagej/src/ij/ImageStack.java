...
public class ImageStack {
	 ...
	 * Returns null if the slice does not have a label or 'n'; is out of range. For
	 * DICOM and FITS stacks, labels may contain header information.
	 */
	 ...
	 * with the extension removed, of the specified slice label, or null if the
	 ...
	 * newline), with the extension removed, of the specified slice label, or null
	 * if the slice does not have a label.
	 */
	...
	/**
	 * Assigns the pixel array of an ImageProcessor to the specified slice, where
	 * {@literal 1<=n<=nslices}.
	 */
