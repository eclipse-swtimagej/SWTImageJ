 ...
 */
public class ResultsTableMacros implements Runnable, DialogListener, org.eclipse.swt.events.SelectionListener, org.eclipse.swt.events.KeyListener {

	private static String NAME = "TableMacro.ijm";
	private String defaultMacro = "Sin=sin(row*0.1);\nCos=cos(row*0.1);\nSqr=Sin*Sin+Cos*Cos;";
	private GenericDialog gd;
	private ResultsTable rt, rtBackup;
	private org.eclipse.swt.widgets.Button runButton, resetButton, openButton,
			saveButton;
