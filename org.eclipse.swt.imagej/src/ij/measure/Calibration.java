...
public class Calibration implements Cloneable {
	...
	public static final int STRAIGHT_LINE = 0, POLY2 = 1, POLY3 = 2, POLY4 = 3,
			...
			LOG2 = 9, RODBARD2 = 10, EXP_WITH_OFFSET = 11, GAUSSIAN = 12,
			EXP_RECOVERY = 13;
	...
	public boolean scaledOrOffset() {
		...
		return pixelWidth != 1.0 || pixelHeight != 1.0 || pixelDepth != 1.0 || xOrigin != 0.0 || yOrigin != 0.0 || zOrigin != 0.0;
	}
	...
	public String toString() {
		...
		return "w=" + pixelWidth + ", h=" + pixelHeight + ", d=" + pixelDepth + ", unit=" + unit + ", f=" + function + ", nc=" + (coefficients != null ? "" + coefficients.length : "null") + ", table=" + (cTable != null ? "" + cTable.length : "null") + ", vunit=" + valueUnit + ", bd=" + bitDepth;
	}
}