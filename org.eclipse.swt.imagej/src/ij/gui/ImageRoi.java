...
public class ImageRoi extends Roi {
	...
	public void draw(Graphics g) {
		...
		int sx2 = (int)(screenX(x+width)*ic.aspectRatioX);
		int sy2 = (int)(screenY(y+height)*ic.aspectRatioY);
		...
		g.drawImage(img2, (int)(screenX(x)*ic.aspectRatioX), (int)(screenY(y)*ic.aspectRatioY), sx2, sy2, 0, 0, img.getWidth(null), img.getHeight(null), null);
