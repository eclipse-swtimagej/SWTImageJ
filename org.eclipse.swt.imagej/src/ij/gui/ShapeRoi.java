  ...
  *
	*/
	...
	public void draw(Graphics g) {
		...
		//Changef for SWT!
		AffineTransform aTx = (((Graphics2D)g).getTransform());
		...
		aTx.setTransform(mag*ic.aspectRatioX, 0.0, 0.0, mag*ic.aspectRatioY, -basex*mag*ic.aspectRatioX, -basey*mag*ic.aspectRatioY);
	...
	public void drawRoiBrush(Graphics g) {
		...
		ic.calculateAspectRatio();
		g.drawOval((int)(sx-size/2+offset*ic.aspectRatioX),(int) (sy-size/2+offset*ic.aspectRatioY), (int)(size*ic.aspectRatioX),(int)( size*ic.aspectRatioY));
	}
