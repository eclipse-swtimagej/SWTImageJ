...
public class Line extends Roi {
	...
	public void mouseMoved(MouseEvent e) {
		...
		drawLine((int)(e.getX() / ic.aspectRatioX), (int)(e.getY() / ic.aspectRatioY));
	}
	...
	public void draw(Graphics g) {
		...
		int sx1 = (int)(screenXD(x1d) * ic.aspectRatioX);
		int sy1 = (int)(screenYD(y1d) * ic.aspectRatioY);
		int sx2 = (int)(screenXD(x2d) * ic.aspectRatioX);
		int sy2 = (int)(screenYD(y2d * ic.aspectRatioY));
