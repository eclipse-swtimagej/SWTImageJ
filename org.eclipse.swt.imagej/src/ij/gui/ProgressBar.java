 ...
 */
public class ProgressBar extends org.eclipse.swt.widgets.Canvas implements PaintListener {
	...
	private Color backgroundColor = gray;
	 ...
	 */
	public ProgressBar(org.eclipse.swt.widgets.Composite parent, int canvasWidth, int canvasHeight) {
