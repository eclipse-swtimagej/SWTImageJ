/*
 * Not needed for SWT. Already available!
 * package ij.gui;
import java.awt.*;
import ij.*;
...
*//**
	 ...
	 * widths of all components is used). When true, components that do not fit the
	 * window will be truncated at the right. The width of the 0th component (the
