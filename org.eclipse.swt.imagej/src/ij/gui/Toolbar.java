...
/** The ImageJ toolbar. */
public class Toolbar extends org.eclipse.swt.widgets.Canvas implements PaintListener, org.eclipse.swt.events.MouseListener, org.eclipse.swt.events.MouseMoveListener, SelectionListener {
	...
	public static final int RECT_ROI = 0, ROUNDED_RECT_ROI = 1,
			ROTATED_RECT_ROI = 2;
	public static final int OVAL_ROI = 0, ELLIPSE_ROI = 1, BRUSH_ROI = 2;
	public static final String[] builtInTools = {"Arrow", "Brush", "Command Finder", "Developer Menu", "Flood Filler", "Label Maker", "LUT Menu", "Overlay Brush", "Pencil", "Pixel Inspector", "Selection Rotator", "Spray Can", "Stacks Menu", "ROI Menu"};
	...
	private org.eclipse.swt.widgets.Menu pointPopup, linePopup, zoomPopup,
			pickerPopup, switchPopup;
	...
	private org.eclipse.swt.widgets.MenuItem straightLineItem, polyLineItem,
			freeLineItem, arrowItem;
	...
	public static final int SPARE1 = UNUSED, SPARE2 = CUSTOM1, SPARE3 = CUSTOM2,
			SPARE4 = CUSTOM3, SPARE5 = CUSTOM4, SPARE6 = CUSTOM5,
			SPARE7 = CUSTOM6, SPARE8 = CUSTOM7, SPARE9 = 22;
	...
	public Toolbar(Composite parent) {
		...
		resetButtons();
		down[0] = true;
		/*When the OS dark mode is set make the selected icons darker!
		 *See: https://help.eclipse.org/latest/index.jsp?topic=%2Forg.eclipse.platform.doc.isv%2Freference%2Fapi%2Forg%2Feclipse%2Fswt%2Fwidgets%2FDisplay.html&anchor=isSystemDarkTheme()*/
	...
	void addPopupMenus() {
		...
		org.eclipse.swt.widgets.MenuItem viewHundredPercentItem = new org.eclipse.swt.widgets.MenuItem(zoomPopup, SWT.PUSH);
		viewHundredPercentItem.setText("View 100%");
		viewHundredPercentItem.addSelectionListener(this);
		org.eclipse.swt.widgets.MenuItem zoomToSelectionItem = new org.eclipse.swt.widgets.MenuItem(zoomPopup, SWT.PUSH);
	...
	public void triggerPopupMenu(int newTool, org.eclipse.swt.events.MouseEvent evt, boolean isRightClick, boolean isLongPress) {
		...
		if(isMacroTool(newTool)) {
			...
			if(name.indexOf("Action Tool") != -1) {
				if(evt.button == 3 || (evt.stateMask & SWT.CTRL) != 0 || (evt.stateMask & SWT.SHIFT) != 0 || (evt.stateMask & SWT.ALT) != 0) {
