...
public class StackStatistics extends ImageStatistics {
	...
	/**
	 * Creates a StackStatistics object from a stack, using 256 histogram bins and
	 * the entire stack pixel value range.
	 */
	...
	/**
	 * Creates a StackStatistics object from a stack, using the specified histogram
	 * bin count and x-axis range (pixel value tange).
	 */
