...
public class SWTGraphics2D extends Graphics2D {
	 ...
	 *
	 * @throws IllegalArgumentException if {@code hintValue} is not compatible with
	 *                                  the {@code hintKey}.
	 *
	 ...
	 * Sets the transform.
	 *
	 * @param t the new transform ({@code null} permitted, resets to the identity
	 *          transform).
	 *
	 * @see #getTransform()
	 */
	...
	public FontMetrics getFontMetrics(Font font) {
		return ImageJ.DUMMY_PANEL.getFontMetrics(font);
	}
